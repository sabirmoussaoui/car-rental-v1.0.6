...
export const ClientLayoutRoutes: Routes = [
    ...
    { path: 'client/user-profile',   component: UserProfileComponent },
    { path: 'client/tables',         component: TablesComponent },
    { path: 'client/icons',          component: IconsComponent },
    { path: 'client/maps',           component: MapsComponent }
];
